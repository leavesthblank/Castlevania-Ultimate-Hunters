...
public class ClientProxyClass extends CommonProxyClass {
    ...
    /*
     * public ModelResourceLocation grapplinghookloc = new ModelResourceLocation("GrappleMod:grapplinghook",
     * "inventory");
     ...
     * public ModelResourceLocation smarthookropeloc = new ModelResourceLocation("GrappleMod:smarthookrope",
     * "inventory");
     ...
     * public ModelResourceLocation multihookropeloc = new ModelResourceLocation("GrappleMod:multihookrope",
     * "inventory");
     * private void setgrapplebowtextures(Item item, final ModelResourceLocation notinusetexture, final
     * ModelResourceLocation inusetexture) {
     ...
     * // ModelBakery.registerItemVariants(item, fullModelLocation); // Ensure the custom model is loaded and prevent
     * the default model from being loaded
    ...
    public void init(FMLInitializationEvent event, GrappleMod grappleModInst) {
        ...
        // Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(GrappleMod.grapplebowitem, 0, new
        // ModelResourceLocation("GrappleMod:grapplinghook", "inventory"));
        // Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(GrappleMod.hookshotitem, 0, new
        // ModelResourceLocation("GrappleMod:hookshot", "inventory"));
        // Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(GrappleMod.launcheritem, 0, new
        // ModelResourceLocation("GrappleMod:launcheritem", "inventory"));
        // Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(GrappleMod.longfallboots, 0, new
        // ModelResourceLocation("GrappleMod:longfallboots", "inventory"));
        // Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(GrappleMod.enderhookitem, 0, new
        // ModelResourceLocation("GrappleMod:enderhook", "inventory"));
    }
    ...
    public void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (player != null) {
            if (!Minecraft.getMinecraft()
                ...
                leftclick = (GameSettings.isKeyDown(Minecraft.getMinecraft().gameSettings.keyBindAttack)
    ...
    public static boolean isactive(ItemStack stack) {
        ...
        // if (p.getItemStackFromSlot(EntityEquipmentSlot.MAINHAND) == stack ||
        // p.getItemStackFromSlot(EntityEquipmentSlot.OFFHAND) == stack) {
