...
public class RenderGrapple extends Render {
    ...
    private static final ResourceLocation GRAPPLE_TEXTURE = new ResourceLocation(
        Castlevania.MODID,
        "textures/entity/silver_grapple.png");
    ...
    private void renderLine(EntityWhipHook hook, float what) {
        ...
        float var12 = (float) (hook.shootingEntity.posX - hook.posX
            - (hook.prevPosX - hook.posX) * (double) (1.0F - what));
        float var13 = (float) (hook.shootingEntity.posY - 1.0D
            - hook.posY
            - (hook.prevPosY - hook.posY) * (double) (1.0F - what));
        float var14 = (float) (hook.shootingEntity.posZ - hook.posZ
            - (hook.prevPosZ - hook.posZ) * (double) (1.0F - what));
        float var15 = MathHelper.sqrt_float(var12 * var12 + var14 * var14);
        GL11.glRotatef(
            (float) (-Math.atan2((double) var14, (double) var12)) * 180.0F / 3.1415927F - 90.0F,
            0.0F,
            1.0F,
            0.0F);
        GL11.glRotatef(
            (float) (-Math.atan2((double) var15, (double) var13)) * 180.0F / 3.1415927F - 90.0F,
            1.0F,
            0.0F,
            0.0F);
